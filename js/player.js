...
import { keys, vehicle, canInteractWithVehicle, closestVehicle } from './main.js';
import { scene, camera, world, playerMaterial } from './scene.js';
...
class Player {
    ...
    update(deltaTime) {
        if (this.isInVehicle) {
            this.body.position.copy(vehicle.body.position);
        ...
        // Movement
        const speed = this.sprinting ? 6000 : 4000; // Increased speed
        const moveDirection = new THREE.Vector3();
        
        // Debug movement inputs
